...
![Salt-pepper sweep 5D/8D](../outputs/saltpepper_sweep_5d8d.png)
...
![QPP QNN model structure](../outputs/qpp_qnn_model_structure.png)

![QPP QNN circuit diagram](../outputs/qpp_qnn_circuit_diagram.png)
...
- `outputs/qpp_qnn_model_structure.png`
- `outputs/qpp_qnn_circuit_diagram.png`
