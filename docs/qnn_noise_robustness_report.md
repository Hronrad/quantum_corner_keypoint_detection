...
```text
outputs/runs/qnn_improvement/noise_5d8d/feature_dim_noise_comparison_data/
```
...
- `outputs/qnn_improvement/noise_5d8d/feature_dim_noise_comparison.csv`
- `outputs/qnn_improvement/noise_5d8d/feature_dim_noise_comparison.json`
- `outputs/qnn_improvement/noise_5d8d/feature_dim_noise_comparison.png`
- `outputs/qnn_improvement/noise_5d8d/feature_dim_noise_summary.md`
...
- `outputs/qnn_improvement/noise_5d8d/saltpepper_sweep_5d8d.csv`
- `outputs/qnn_improvement/noise_5d8d/saltpepper_sweep_5d8d.json`
- `outputs/qnn_improvement/noise_5d8d/saltpepper_sweep_5d8d.png`
- `outputs/qnn_improvement/noise_5d8d/saltpepper_sweep_5d8d_summary.md`

![Salt-pepper sweep](../outputs/qnn_improvement/noise_5d8d/saltpepper_sweep_5d8d.png)
