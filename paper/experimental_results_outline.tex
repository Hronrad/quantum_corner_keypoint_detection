...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/final_comparison_results.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/ltx_multiclass_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/quantum_family_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{quantum_corner_keypoint_detection/outputs/qpp/noise/qpp_noise_robustness.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{quantum_corner_keypoint_detection/outputs/qnn_improvement/noise_5d8d/saltpepper_sweep_5d8d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.58\linewidth]{quantum_corner_keypoint_detection/outputs/qpp/noise_aware/qpp_noise_aware_results.png}
